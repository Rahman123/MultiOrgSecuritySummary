...
const healthCheckColumns = [
  {
    label: "Status",
    fieldName: "multioss__RiskType__c",
    initialWidth: 150,
    cellAttributes: { class: { fieldName: "riskColor" } }
  },
  {
    label: "Setting",
    fieldName: "multioss__Setting__c",
    initialWidth: 300,
    wrapText: true
  },
...
export default class MultiOrgHealthCheck extends LightningElement {
  ...
  showDetails(event) {
    ...
    const myEvent = new CustomEvent("selectriskdetailmodal", {
      detail: riskId
    });
  ...
  createTaskSelected(event) {
    ...
    const customEvent = new CustomEvent("createtaskselected", {
      detail: detail
    });
